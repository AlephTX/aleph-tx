...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Step 5: Connect to Account Stats
    tracing::info!("💰 Connecting to account stats (/dev/shm/aleph-account-stats)...");
    ...
    let symbol_id = 1002u16;
    let market_id = 0u16;

    // Step 7: Initialize Strategy
    tracing::info!("🎯 Initializing Adaptive Market Maker...");
    ...
    // Step 8: Run Strategy with graceful shutdown
